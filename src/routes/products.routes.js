...
router.post("/api/products",passportCall("jwt"), authorization(["admin","premium"]), productController.createProduct);
//router.post("/api/products", productController.createProduct);

router.put("/api/products/:pid",passportCall("jwt"), authorization(["admin","premium"]),productController.updateProduct);
//router.put("/api/products/:pid",productController.updateProduct);

router.delete("/api/products/:pid", passportCall("jwt"), authorization(["admin","premium"]), productController.deleteProduct);
